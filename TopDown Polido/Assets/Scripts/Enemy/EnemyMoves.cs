...
public class EnemyMoves : MonoBehaviour
{
    ...
    private void ProcurarAlvo()
    {
        ...
        //if (colliderJogador != null)
        //{ //Se tem um jogador para perseguir
        //    if ("Player".Equals(colliderJogador.tag))
    ...
    private void Mover()
    {
        ...
        if (distanciaAtual > this.distanciaMinima)
        { //Se ainda não chegou no player
